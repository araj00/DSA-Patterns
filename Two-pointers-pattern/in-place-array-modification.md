...
Keywords to observe before <u>*applying in-place modification*</u> are **move element, remove the element, remove duplicates, sort the elements(2-4 unique element), swap the elements with true one**.
